...
class Desk360ScreenTicketSuccess  : Serializable{
    ...
    var bottom_note_text: String =
        "Destek mesajlarınız mesai saatleri içerisinde yanıtlar. " +
                "Buraya buna benzer bir içerik mesajı " +
                "ve alt kısa açıklama eklenir. Geliştirici istediği mesajı burada verebilir. Kullanılması zorunlu değildir." +
                " Destek mesajlarınız mesai saatleri içerisinde yanıtlar."
    ...
    var button_text_font_size: Int = 15

    @SerializedName("description")
    var description: String = "Mesajınız alındı."
