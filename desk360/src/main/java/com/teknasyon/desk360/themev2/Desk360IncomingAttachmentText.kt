...
class Desk360IncomingAttachmentText @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        this.setTextColor(Color.parseColor(ticketDetailScreen?.chat_sender_text_color))
        this.setLinkTextColor(Color.parseColor(ticketDetailScreen?.chat_sender_text_color))
